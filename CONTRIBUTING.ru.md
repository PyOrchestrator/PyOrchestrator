...
4. Обновите документацию в `docs/en/` и `docs/ru/` (и при необходимости `wiki/`), если меняется поведение или конфигурация
...
- Страницы в `docs/en/` (основной язык) и `docs/ru/` (второй)
- Навигация: `docs/_data/nav.yml`
- Строки UI: `docs/_data/ui.yml`
- Переключатель языка в сайдбаре / мобильной шапке
- Стили: `docs/assets/css/style.css`

После push в `main` GitHub Actions публикует сайт на Pages: https://pyorchestrator.github.io/PyOrchestrator/ru/

Копия для GitHub Wiki: `wiki/en/` и `wiki/ru/` — публикация: `./scripts/sync-github-wiki.sh`.
...
См. [документацию](https://pyorchestrator.github.io/PyOrchestrator/ru/) или создайте Issue.

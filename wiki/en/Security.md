> **English** · **[Русский](ru-Security)** · [← Wiki](Home)
...
Check at each endpoint via `require_permission()`.
...
See [SECURITY.md](https://github.com/PyOrchestrator/PyOrchestrator/blob/main/SECURITY.md) at the root of the repository.
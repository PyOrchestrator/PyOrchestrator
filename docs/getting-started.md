...
cd PyOrchestrator
git checkout v0.1.11   # или последний тег: git describe --tags --abbrev=0
cp .env.example .env
...
Актуальная версия: [**v0.1.11**](https://github.com/PyOrchestrator/PyOrchestrator/releases/tag/v0.1.11) — [заметки о выпуске]({{ '/release-notes/' | relative_url }}).

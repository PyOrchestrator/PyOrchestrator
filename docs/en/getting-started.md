...
Current version: [**v0.1.13**](https://github.com/PyOrchestrator/PyOrchestrator/releases/tag/v0.1.13) - [release notes]({{ '/en/release-notes/' | relative_url }}).
...
Ports are configured in `.env` - see [Configuration]({{ '/en/configuration/' | relative_url }}).
...
More details: [Deployment]({{ '/en/deployment/' | relative_url }}).
...
More details: [MCP]({{ '/en/mcp/' | relative_url }}).

## Further

- [Architecture]({{ '/en/architecture/' | relative_url }})
- [Control Panel]({{ '/en/control-plane/' | relative_url }})
- [Security]({{ '/en/security/' | relative_url }})

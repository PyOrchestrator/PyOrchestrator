...
> См. [заметки о выпуске]({{ '/ru/release-notes/' | relative_url }}).
...
<p class="quick-links">
  <a href="{{ '/ru/release-notes/' | relative_url }}">Заметки о выпуске</a> ·
  <a href="{{ '/ru/getting-started/' | relative_url }}">Быстрый старт</a> ·
  <a href="{{ '/ru/architecture/' | relative_url }}">Архитектура</a> ·
  <a href="{{ '/ru/control-plane/' | relative_url }}">Панель управления</a> ·
  <a href="{{ '/ru/mcp/' | relative_url }}">MCP</a>
</p>
